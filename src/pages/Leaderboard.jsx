                    ...
                    <section className="grid md:grid-cols-3 gap-4 mb-10">
                        {top3.length > 0 ? (
                            top3.map((m, i) => {
                                ...
                                return (
                                    <article key={m.name} className={`relative rounded-[20px] border border-[#E8ECF4] bg-white shadow-[0_4px_12px_rgba(0,0,0,0.06)] p-6 text-center overflow-hidden ${order} ${scale}`}>
                                        ...
                                        <p className="text-[18px] font-semibold leading-tight text-[#1E2A45]">{m.name}</p>
                                        <p className="text-xs text-[#8A94A6] mt-0.5">{t(m.rank)} · {t(m.group)}</p>
                                        <p className="text-[20px] font-bold text-[#4A7DFF] mt-4">{m.honor}</p>
                                ...
                                <tbody>
                                    {rest.map((m, i) => (
                                        <tr key={m.name} className="border-t border-[#E8ECF4] hover:bg-[#F4F6FB]/40 transition-colors">
                                            ...
                                            <td className="py-3 px-2 text-end text-[#8A94A6]">{m.hours}</td>
